...
<template>
  <div id="editing_filed">
    <div>
      ...
      <div class="title_area">
        <div class="page_title">
          <div class="page_title_left">业务组件设置</div>
    ...
    <div class="business_component">
      <!-- 内容 -->
      <div>
        <div v-for="(item,index) in comData">
          <div class="component_show">
            <div class="component_field">
              <div class="component_field">
                <input class="business_component_title" type="text" v-model="comData[index].title" />
                <input class="business_component_value" type="text" v-model="comData[index].value" />
              </div>
            </div>
          </div>
    ...
    comEditData(newVal) {
      ...
      for (let index = 0; index < newVal.componentInfo.length; index++) {
        this.comData.push({
          ...
          value: newVal.componentInfo[index].index
        });
      }
    }
  },
